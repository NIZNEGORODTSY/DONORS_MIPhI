...
async def process_event_blood_center(message: Message, state: FSMContext):
    ...
    await message.answer(f"Мероприятие на {data['date']} в {data['blood_center']} создано!", reply_markup=get_organizer_keyboard())
